...
<body data-new-gr-c-s-loaded="14.1093.0"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body" cellspacing="0" cellpadding="0" bgcolor="#f7f8fe"
                                    align="center" data-darkreader-inline-bgcolor
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#f7f8fe;width:600px">
                                    <tr>
                                        <td align="left"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://ymeqrb.stripocdn.email/content/guids/CABINET_5eae849450c9c7e56dcfba2762efdbca650c601e3c012d7a76030a1dc5628c62/images/icon.png"
                                                                        alt
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#f7f8fe"
                                    align="center" data-darkreader-inline-bgcolor
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#f7f8fe;width:600px">
                                    <tr>
                                        <td align="left"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:10px;Margin:0">
                                                                    <h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:georgia, times, 'times new roman', serif;font-size:24px;font-style:normal;font-weight:normal;color:#0c0404"
                                                                        data-darkreader-inline-color><strong>New
                                                            ...
                                                            <tr>
                                                                <td align="right" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        <strong>Schedule</strong>: {{$appointment->schedule}}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="right" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:27px;color:#333333;font-size:18px">
                                                                        <strong>Price</strong>: <span style="color: green;">${{$appointment->price}}</span></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <!--[if mso]><a href="" target="_blank" hidden> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" style="height:41px; v-text-anchor:middle; width:133px" arcsize="10%" stroke="f" fillcolor="#060606"> <w:anchorlock></w:anchorlock> <center style='color:#cdcbc8; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px; mso-text-raise:1px'>Check Now</center> </v:roundrect></a><![endif]--><!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border-2 es-button-border"
                                                                        style="border-style:solid;border-color:#2cb543;background:#000000;border-width:0px;display:inline-block;border-radius:4px;width:auto;mso-hide:all"
                                                                        data-darkreader-inline-border-top
                                                                        data-darkreader-inline-border-right
                                                                        data-darkreader-inline-border-bottom
                                                                        data-darkreader-inline-border-left
                                                                        data-darkreader-inline-bgimage
                                                                        data-darkreader-inline-bgcolor><a href=""
                                                                            class="es-button es-button-1 msohide"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#000000;border-width:10px 20px 10px 20px;display:inline-block;background:#000000;border-radius:4px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;mso-hide:all"
                                                                            data-darkreader-inline-bgimage
                                                                            data-darkreader-inline-bgcolor
                                                                            data-darkreader-inline-border-top
                                                                            data-darkreader-inline-border-right
                                                                            data-darkreader-inline-border-bottom
                                                                            data-darkreader-inline-border-left>Check
                                                                            Now</a></span><!--<![endif]--></td>
                                                            </tr>
                                                        </table>
                                                    </td>
